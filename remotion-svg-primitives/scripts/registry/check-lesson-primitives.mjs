...
//
// Returns { resolved, unresolvedKebab }:
...
function namedComponents(text, idToComponent) {
  ...
  return { resolved, unresolvedKebab };
}
...
for (const arg of args) {
  ...
  const { resolved, unresolvedKebab } = namedComponents(text, ID_TO_COMPONENT);
